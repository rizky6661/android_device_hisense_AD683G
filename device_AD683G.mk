...
-include vendor/hisense/AD683G/AD683G-vendor-blobs.mk
...
# Ramdisk
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,device/hisense/AD683G/rootdir,root)
...
# For ATH6KL
PRODUCT_COPY_FILES += \
   $(LOCAL_PATH)/wlan_chip_id:$(PRODUCT_OUT)/persist/wlan_chip_id
